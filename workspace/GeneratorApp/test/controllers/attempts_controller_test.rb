...
class AttemptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attempt" do
    assert_difference('Attempt.count') do
      post attempts_url, params: { attempt: { description: @attempt.description, title: @attempt.title } }
    end
  ...
  test "should update attempt" do
    patch attempt_url(@attempt), params: { attempt: { description: @attempt.description, title: @attempt.title } }
